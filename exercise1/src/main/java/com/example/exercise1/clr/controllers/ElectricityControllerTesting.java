...
public class ElectricityControllerTesting implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        TestUtils.printTestInfo("electricity controller - get all");
        String res = restTemplate.getForObject(URL, String.class);
        System.out.println(res);

        TestUtils.printTestInfo("electricity controller - save");
        ...
        TestUtils.printTestInfo("electricity controller - update");
        try {
        ...
        TestUtils.printTestInfo("electricity controller - get one item");
        try {
        ...
        TestUtils.printTestInfo("electricity controller - count item");
        res = restTemplate.getForObject(URL + "/count", String.class);
        System.out.println(res);

        System.out.println("end of electricity controller test");
    }
}
